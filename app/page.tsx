  ...
  return (
    <main className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-white transition-colors lg:pr-[300px]">
      ...
      <TechNews
        ...
        hidden={false}
      />
       <section className="flex items-center justify-center pl-52 pr-6 pt-10 pb-10">
      ...
      <footer className="border-t border-slate-200 dark:border-slate-800 py-8 pl-52 pr-6 text-center text-slate-500 text-sm transition-colors">
        <p>
