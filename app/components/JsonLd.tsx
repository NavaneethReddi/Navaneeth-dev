export default function JsonLd() {
  const person = {
    ...
    url: 'https://clerk-nextjs-phi.vercel.app', jobTitle: 'Principal Architect',
  ...
  const website = { '@context': 'https://schema.org', '@type': 'WebSite', name: 'Navaneeth Reddy — Portfolio', url: 'https://clerk-nextjs-phi.vercel.app' }
  return (
    <>
